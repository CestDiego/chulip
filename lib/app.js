...
/***/ function(module, exports, __webpack_require__) {
	...
	var messagesRef = _firebaseUtilsJs2['default'].ref.child("messages");
	...
	var ChatBox = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_TopBarJsx2['default'], { stream: this.state.stream, streamList: this.state.streamList,
	        onStreamChange: this.handleStreamChange }),
	      _react2['default'].createElement(_MessageListJsx2['default'], { stream: this.state.stream,
	        messages: this.state.messages, user: this.state.user }),
	      _react2['default'].createElement(_MessageFormJsx2['default'], { stream: this.state.stream,
	...
	var Message = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement('span', { className: 'small-10 columns', dangerouslySetInnerHTML: this.rawMarkup() }),
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('input', { ref: 'stream', type: 'text', defaultValue: this.props.stream,
	        ...
	        _react2['default'].createElement(
	          'button',
	          { className: 'button success', type: 'submit',
	            disabled: !_firebaseUtils2['default'].isLoggedIn() },
	          'Post'
	        )
	      )
	...
	var TopBar = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'form',
	        { className: 'large-6 columns', onSubmit: this.handleSubmit },
	        _react2['default'].createElement(
	          'select',
	          { ref: 'streamSelect' },
	          options
