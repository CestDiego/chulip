...
/******/ 	__webpack_require__.p = "/home/io/Projects/react-webpack-starter/example";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatBoxJsx = __webpack_require__(199);
	
	var _ChatBoxJsx2 = _interopRequireDefault(_ChatBoxJsx);
	...
	var App = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(_ChatBoxJsx2['default'], { url: 'http://localhost:3000/api/comments' });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _firebase = __webpack_require__(201);
	
	var _firebase2 = _interopRequireDefault(_firebase);
	
	var _firebaseUtilsJs = __webpack_require__(202);
	
	var _firebaseUtilsJs2 = _interopRequireDefault(_firebaseUtilsJs);
	
	var _MessageListJsx = __webpack_require__(203);
	
	var _MessageListJsx2 = _interopRequireDefault(_MessageListJsx);
	
	var _MessageFormJsx = __webpack_require__(206);
	
	var _MessageFormJsx2 = _interopRequireDefault(_MessageFormJsx);
	
	var _TopBarJsx = __webpack_require__(207);
	
	var _TopBarJsx2 = _interopRequireDefault(_TopBarJsx);
	
	var messageRef = _firebaseUtilsJs2['default'].ref.child("messages");
	...
	var ChatBox = _react2['default'].createClass({
	  ...
	  handleStreamChange: function handleStreamChange(newStream) {
	    this.setState({
	      data: {
	        stream: newStream
	      }
	  ...
	  handleLogin: function handleLogin(e) {
	    if (!_firebaseUtilsJs2['default'].isLoggedIn()) {
	      _firebaseUtilsJs2['default'].loginWithGitHub((function (userData) {
	        this.setState({
	          user: userData
	        });
	      }).bind(this));
	      ...
	      _firebaseUtilsJs2['default'].logout();
	      var userData = {
	        id: '-1',
	        username: "guest",
	        name: "Guest",
	  ...
	  getInitialState: function getInitialState() {
	    var authData = _firebaseUtilsJs2['default'].ref.getAuth();
	    if (authData) {
	      var userData = {
	        id: authData.uid,
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_reactFontawesome2['default'], { className: 'super-crazy-colors', name: 'rocket', size: '2x', spin: true }),
	      _react2['default'].createElement(_TopBarJsx2['default'], { data: this.state.data, onStreamChange: this.handleStreamChange }),
	      _react2['default'].createElement(_MessageListJsx2['default'], { data: this.state.data, user: this.state.user }),
	      _react2['default'].createElement(_MessageFormJsx2['default'], { onMessageSubmit: this.handleMessageSubmit, user: this.state.user }),
	      _react2['default'].createElement(
	        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var firebaseRef = new _firebase2['default'](forge);
	var cachedUser = null;
	...
	var firebaseUtils = {
	  ref: firebaseRef,
	  cachedUser: {},
	  getUserData: function getUserData(uid, callback) {
	  ...
	  loginWithGitHub: function loginWithGitHub(callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageJsx = __webpack_require__(204);
	...
	var MessageList = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    var streamRef = _firebaseUtilsJs2['default'].ref.child('messages').child(stream);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(205);
	
	var _marked2 = _interopRequireDefault(_marked);
	
	var _firebaseUtils = __webpack_require__(202);
	...
	var Message = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    _firebaseUtils2['default'].ref.child("users").child(authorId).on('value', (function (data) {
	      var author = data.val();
	      this.setState({
	        author: author
	      });
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement('img', { src: this.state.author.pic, style: { height: '40px', width: '40px' } }),
	      _react2['default'].createElement('span', { dangerouslySetInnerHTML: this.rawMarkup() })
	    );
	  },
	  propTypes: {
	    onRender: _react2['default'].PropTypes.func,
	    authorId: _react2['default'].PropTypes.string
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageForm = _react2['default'].createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    var stream = _react2['default'].findDOMNode(this.refs.stream).value.trim();
	    if (!text || !stream) {
	      return;
	    }
	    console.log(this.props);
	    if (_firebaseUtils2['default'].isLoggedIn()) {
	    ...
	    _react2['default'].findDOMNode(this.refs.stream).value = '';
	    return;
	  },
	  getInitialState: function getInitialState() {
	    return null;
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { ref: 'stream', type: 'text', value: 'default',
	            disabled: !_firebaseUtils2['default'].isLoggedIn() }),
	          _react2['default'].createElement('textarea', { ref: 'text', placeholder: 'Say something nice...',
	            disabled: !_firebaseUtils2['default'].isLoggedIn() })
	        ),
	...
	var TopBar = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement('form', { className: 'ChannelForm', onSubmit: this.handleSubmit })
	    );
	  },
	  propTypes: {
	    onRender: _react2['default'].PropTypes.func
